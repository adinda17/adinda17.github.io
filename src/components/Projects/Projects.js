...
import cvbkr from "../../Assets/Projects/cvbkr.png";
import suratjalan from "../../Assets/Projects/suratjalan.png";
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            {/* Tambahkan import cover image di bagian atas file (dekat import cvbkr yang sudah ada), contoh: */}
{/* import suratJalanCover from "../../Assets/Projects/suratjalan-cover.png"; */}
...
<Col md={4} className="project-card">
  <ProjectCard
    ...
    delivery note (Surat Jalan) process for Baropi Group, a multi-brand F&B company
    with multiple internal divisions and outlets. Covers stakeholder analysis, business
    process modeling (As-Is vs To-Be), RBAC design, conceptual data modeling, and a
    working low-code prototype that replaces manual, unsecured paper signatures with
    a role-based digital workflow."
    linkType="github"
    demoLink="/suratjalan"
  />
</Col>
                     ...
                     <Col md={4} className="project-card">
                      <ProjectCard
                        imgPath={cvbkr}
                        isBlog={false}
                        title="Marketing Production & Request Management System"
                        description="A full SA documentation project born from real experience as a 
                        Graphic Designer at a multi-brand F&B company.After nearly 2 years of receiving design requests via WhatsApp 
                        and verbal conversations with no tracking system, I documented a solution: a structured marketing workflow platform covering 
                        dual approval, revision control, and audit trail. 14 deliverables — BRD, SRS, ERD, User Story, BPMN, 7 diagrams, 
                        Test Plan, UAT, and Traceability Matrix."
